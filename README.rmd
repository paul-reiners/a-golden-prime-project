...
What's interesting is to color these points using the number of prime divisors
of each number.
...
For even numbers between 4 and 100,000, how many even numbers only have one pair of
distinct pairs of primes adding to it?  How many evens have exactly two distinct
pairs of primes adding to it?  Exactly three?  Four?  Higher?
